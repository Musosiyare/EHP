                                ...
                                <div class="block-content">
                                    <form method="post" onsubmit="return checkpass();" name="changepassword">
                                        <div class="form-group row">
                                            <label class="col-12" for="register1-username">Current Password: <span
                                        ...
                                        <div class="form-group row">
                                            <label class="col-12" for="register1-email">New Password: <span
                                                    style="color:red;">*</span></label>
                                            <div class="col-12">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-12" for="register1-password">Confirm Password: <span
                                                    style="color:red;">*</span></label>
                                            <div class="col-12">
