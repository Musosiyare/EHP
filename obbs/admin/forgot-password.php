...
<head>
    <title>Event Handler Platform - Forgot Page</title>
...
<body>
    ...
    <div id="page-container" class="main-content-boxed">
        ...
        <main id="main-container">
            <!-- Page Content -->
            <div class="bg-image" style="background-image: url('assets/img/photos/bg3.jpg');">
                <div class="row mx-0 bg-black-op">
                    <div class="hero-static col-md-6 col-xl-8 d-none d-md-flex align-items-md-end">
                        <div class="p-30 invisible" data-toggle="appear">
                            <p class="font-size-h3 font-w600 text-white">
                                Event Handler Platform
                                <i class="fa fa-heart text-pulse" style="font-size:32px;"></i>
                            </p>
                    ...
                    <div class="hero-static col-md-6 col-xl-4 d-flex align-items-center bg-white invisible"
                        ...
                        <div class="content content-full">
                            ...
                            <form class="js-validation-signin px-30" method="post" name="chngpwd"
