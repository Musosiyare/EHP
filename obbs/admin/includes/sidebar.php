        ...
        <div id="sidebar-scroll">
            ...
            <div class="sidebar-content">
                    ...
                    <div class="content-header-section text-center align-parent sidebar-mini-hidden">
                        ...
                        <div class="content-header-item">
                            <a class="link-effect font-w700" href="dashboard.php">
                                ...
                                <span class="font-size-xl text-dual-primary-dark">EHP</span>|<span
                        ...
                        <ul class="list-inline mt-10">
                            ...
                            <li class="list-inline-item">
                                ...
                                <a class="link-effect text-dual-primary-dark" data-toggle="layout"
                                    data-action="sidebar_style_inverse_toggle" href="admin-profile.php">
                ...
                <div class="content-side content-side-full">
                    <ul class="nav-main">
                        <li class="open">
                            <a href="dashboard.php"><i class="si si-cup"></i><span
                                    class="sidebar-mini-hide">Dashboards</span></a>

                        </li>

                        <li class="nav-main-heading"><span class="sidebar-mini-visible">UI</span><span
                                class="sidebar-mini-hidden"></span></li>
                        <li>
                            <a class="nav-submenu" data-toggle="nav-submenu"><i class="si si-puzzle"></i><span
                                    class="sidebar-mini-hide"></span>Events</a>
                            <ul>
                                <li>
                        ...
                        <li>
                            <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-layers"></i><span
                                    class="sidebar-mini-hide">Pages</span></a>
                            <ul>
                                <li>
                        ...
                        <li>
                            <a href="between-dates-report.php"><i class="si si-vector"></i><span
                                    class="sidebar-mini-hide">B/w Dates Report</span></a>

                        </li>

                        <li>
                            <a href="booking-search.php"><i class="si si-cup"></i><span class="sidebar-mini-hide">Booking
                                    Search</span></a>
