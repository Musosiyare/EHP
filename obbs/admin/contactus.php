...
if (strlen($_SESSION['odmsaid'] == 0)) {
    ...
    <head>
        <title>Event Handler Platform - Update Contact Us</title>
        ...
        <div id="page-container" class="sidebar-o sidebar-inverse side-scroll page-header-fixed main-content-narrow">
            ...
            <main id="main-container">
                ...
                <div class="content">
                    ...
                    <!-- Register Forms -->
                    <h2 class="content-heading"><strong>Update Contact Us</strong></h2>
                    <div class="row">
                        <div class="col-md-12">
                            <!-- Bootstrap Register -->
                            <div class="block block-themed">
                                <div class="block-header bg-gd-emerald">
                                    <h3 class="block-title"><strong>Update Contact Us</strong></h3>
