...
if (strlen($_SESSION['odmsaid'] == 0)) {
    ...
    <head>
        <title>Event Handler Platform - New Booking</title>
    ...
    <body>
        ...
        <div id="page-container" class="sidebar-o sidebar-inverse side-scroll page-header-fixed main-content-narrow">
            ...
            <main id="main-container">
                <!-- Page Content -->
                <div class="content">
                    <h2 class="content-heading"><strong>New Booking</strong></h2>
                    ...
                    <div class="block">
                        <div class="block-header block-header-default">
                            <h3 class="block-title"><strong>New Booking</strong></h3>
                        </div>
                                        ...
                                        foreach ($results as $row) { ?>
                                            <tr>
                                                ...
                                                <td class="d-none d-sm-table-cell"><a
                                                        href="view-booking-detail.php?editid=<?php echo htmlentities($row->bid); ?>&&bookingid=<?php echo htmlentities($row->BookingID); ?>"><i
