  ...
  <tr>
   ...
   <tr>
    ...
    <td><span class="text-danger">Frw</span>
      <?php  echo $row->ServicePrice;?></td>
      <th>Total price</th>
    <td><span class="text-danger">Frw</span>
      <?php  echo $row->TotalPrice;?></td>
  </tr>
