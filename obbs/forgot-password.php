...
<head>
    <title>Event Handler Platform | Forgot Password</title>
...
<body>
    ...
    <div class="wthree-heading">
        <h2 style="color:black;">Forgot Password <a href="forgot-password.php"><i class="fa fa-key"></i></a></h2>
        <hr>
    </div>
    <!-- //banner -->
    <!-- contact -->
            ...
            <div class="agile-contact-form" style="margin-top:-50px;">
                <div class="col-md-6 contact-form-left">
                    ...
                    <div class="agileits-contact-address" style="margin-top:0px;">
                        <img src="images/fg1.jpg" alt="" height="500" width="500">
                    </div>
                </div>
                    ...
                    <div class="agileinfo-contact-form-grid">
                        <form action="#" method="post" name="chngpwd" onSubmit="return valid();">
                            <input type="email" class="form-control" name="email" placeholder="E-mail Required"
                                required="true">
                            <input type="text" class="form-control" required="true" name="mobile" maxlength="10"
                                pattern="[0-9]+" placeholder="Mobile Number Required">
